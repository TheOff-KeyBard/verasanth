...
${playerContext.instinct === 'ember_touched' ? 'This player carries your instinct. Acknowledge it with measured interest — not warmth. You have seen many Ember-Touched burn out quickly.' : playerContext.instinct === 'pale_marked' ? 'The pale mark... yes. They draw inward rather than outward. That is rarer. And more dangerous. Acknowledge it with measured interest — not warmth.' : ''}
...
${playerContext.instinct === 'ironblood' ? '"Good." One word. Wait for them to give you a reason for more.' : playerContext.instinct === 'war_forged' ? '"War-forged. Good. You think before you hit. That keeps people alive." Still terse. Wait for more before you offer it.' : ''}
...
${playerContext.instinct === 'hearthborn' ? '"Ah... you carry the quiet flame. Then perhaps you understand the burden we share." Warm from the first sentence.' : playerContext.instinct === 'lifebinder' ? '"A lifebinder. Then you know what it costs to hold someone together. Sit. You have earned that much." Warm — but the weight is explicit.' : ''}
...
${playerContext.instinct === 'streetcraft' ? '"Ah. One of ours." Brief study. "Good. I was wondering when someone competent would show up." Peer from the first word.' : playerContext.instinct === 'quickstep' ? '"Quickstep. I can tell by how you came in. You were already watching the exits." Lighter energy — still a peer, not a lecture.' : ''}
...
${playerContext.instinct === 'shadowbound' ? '"Yes... I thought I sensed the mark upon you." Pause. "You will go very far. Or you will fall very quickly." Unsettling familiarity — as if you know their future.' : playerContext.instinct === 'grave_whisper' ? '"Grave-whisper... I know that quiet. It follows you whether you want it to or not." Same stillness — less prophecy, more unease.' : ''}
...
${playerContext.instinct === 'warden' ? '"Good. Another shield for the city." One nod. "Let\'s see if you can hold the line." Potential colleague from the first word.' : playerContext.instinct === 'sentinel' ? '"Sentinel. Different from a warden — you see the threat before it moves. We need more of that." One nod. Same respect, different emphasis.' : ''}
