...
export const SEWER_NODES = {
  ...
  overflow_channel: {
    ...
    objects: {
      ...
      symbol_stone: { desc: "A single symbol cut into the channel wall, same style as the marks in Veyra's shop. An apology. You have seen this before.", actions: ["inspect"] },
      wall_markings: { desc: "M. DASK — 3RD SHIFT. STILL HERE. Carved in stone with newer stone built around it. Someone left a message. The stone remembers.", actions: ["inspect", "read"] },
    },
    items: [],
  },
  broken_pipe_room: {
  ...
  old_maintenance_room: {
    ...
    objects: {
      ...
      wall_orders: { desc: "Duty rosters, patrol schedules, a list of names on brittle paper.", actions: ["inspect", "read"] },
    },
    items: [],
  },
  echoing_hall: {
  ...
  flooded_hall: {
    ...
    objects: {
      ...
      cistern_stone: { desc: "Stone at the water's edge. Something is embedded in it — same material as Pip, same faint glow. A fragment. Diagnostic.", actions: ["inspect"] },
    },
    items: [],
  },
  drowned_archive: {
  ...
  drowned_vault: {
    ...
    objects: {
      ...
      stone_shelves: { desc: "Stone shelves along the vault wall. Documents, markers, and in a small carved alcove — a second fragment. Same material as Pip. Slightly larger.", actions: ["inspect"] },
    },
    items: [],
  ...
  sewer_deep_foundation: {
    ...
    objects: {
      ...
      origin_pattern: { desc: "The floor pattern. It matches the map's central district. This is what was here before. The city was built on top of itself.", actions: ["inspect"] },
      deep_air: { desc: "DASK etched in stone that has never been worked. Original. The name was here before the city learned to forget.", actions: ["inspect"] },
    },
    items: [],
  },
  sump_pit: {
