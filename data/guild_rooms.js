...
export const GUILD_ROOMS = {
  ...
  broken_banner_yard: {
    ...
    objects: {
      garruk: { desc: "Garruk Stonehide — massive even by orc standards, armor scarred but maintained with care that borders on ritual. The tattered banner across his shoulders. Ritual combat scars on his skin. He does not look up from the bout when you enter. When he does look up, his assessment takes one second and he keeps the conclusion.", actions: ["talk", "inspect"] },
