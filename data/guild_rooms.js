...
export const GUILD_ROOMS = {
  ...
  ashen_archive_hall: {
    ...
    objects: {
      ...
      ember_touched_adept: { desc: "A figure working at one of the stone tables near the brazier, movements precise and unhurried. They don't look up when someone enters. They look up when something changes. The difference is visible if you watch long enough.", actions: ["talk", "inspect"] },
      pale_marked_survivor: { desc: "A figure standing near the archive shelves, not reading. Present in the way of someone who has learned that stillness is its own kind of attention. The warmth of the room doesn't seem to reach them the same way it reaches everyone else.", actions: ["talk", "inspect"] },
      archive_initiate: { desc: "A newer face near the sealed vault doors, not trying to open them — standing close to them the way someone stands near a sound they can almost hear. Their attention keeps returning to the same point on the wall.", actions: ["talk", "inspect"] },
  ...
  stone_watch_hall: {
    ...
    objects: {
      ...
      stone_watch_defender: { desc: "A broad figure standing near the formation marks on the floor, weight settled, arms loose. Not relaxed — positioned. They watch the patrol board the way someone watches a map they've already memorized.", actions: ["talk", "inspect"] },
      stone_watch_sentinel: { desc: "A figure near the hall entrance, facing inward. They were watching the door before you came through it. Their attention moves in short arcs — gate, corridor, patrol board, back to gate. Never idle.", actions: ["talk", "inspect"] },
      watch_initiate: { desc: "A newer face near the weapon rack, standing slightly apart from the others. Their eyes move between the defender and the sentinel the way someone watches two people argue in a language they're still learning.", actions: ["talk", "inspect"] },
  ...
  broken_banner_yard: {
    ...
    objects: {
      ...
      ironblood_veteran: { desc: "A broad figure standing at the edge of the largest sparring circle, arms crossed, watching the bout without expression. Not idle — processing. Every stance, every footfall gets filed. They correct without raising their voice.", actions: ["talk", "inspect"] },
      war_forged_bruiser: { desc: "A fighter moving through drills at the weapon rack, each repetition faster than the last. They don't watch the sparring circles the way the veteran does — they watch for openings. Always forward-facing.", actions: ["talk", "inspect"] },
      banner_recruit: { desc: "A newer face near the gate, armor worn like it doesn't quite fit yet. Watching both the veteran and the bruiser with the attention of someone trying to determine which one to imitate.", actions: ["talk", "inspect"] },
  ...
  quiet_sanctum_entrance: {
    ...
    objects: {
      ...
      hearth_tender: { desc: "A figure moving slowly between those present in the Sanctum, pausing at each without lingering. Their attention is complete and then gone, distributed evenly. They do not appear tired. The tiredness is in something smaller — the way they hold their hands when they think no one is watching.", actions: ["talk", "inspect"] },
      lifebinder_adherent: { desc: "A figure seated near the back of the room, slightly apart. Not watching the room — watching one person in it, with the full attention of someone who has decided that person matters. When that person leaves, they are still for a moment before they look up.", actions: ["talk", "inspect"] },
      sanctum_newcomer: { desc: "A newer face near the healing pool, not touching it. Standing close enough that the warmth reaches them. They look like someone who arrived needing something specific and has not yet found the words for it.", actions: ["talk", "inspect"] },
  ...
  veil_market_hidden: {
    ...
    objects: {
      ...
      streetcraft_operative: { desc: "A figure already seated when you arrive, position chosen with the unhurried precision of someone who arrived early enough to pick it. They are watching the room's exits in a sequence that looks casual and isn't.", actions: ["talk", "inspect"] },
      quickstep_runner: { desc: "A figure in motion when you notice them — not pacing, moving with purpose between two points that don't require a path. They stop when they choose to, not when they run out of space.", actions: ["talk", "inspect"] },
      market_initiate: { desc: "A newer face near the back of the room, trying to watch everything at once. Their attention keeps splitting — toward the operative, toward the runner, toward the exits — and never quite settling.", actions: ["talk", "inspect"] },
  ...
  umbral_covenant_hall: {
    ...
    objects: {
      ...
      shadowbound_adept: { desc: "A composed figure at the hall's edge — stillness that reads as discipline, not ease. They watch the geometry of the room more than the people in it: where shadow falls wrong, where the crystals hum half a breath out of step. When someone moves, their eyes track the inconsistency first. They believe truth is buried and must be uncovered through rigor. They hold a quiet skepticism toward those who wait on whispers from absences — as if listening were the same as knowing.", actions: ["talk", "inspect"] },
      grave_whisper_adherent: { desc: "A quiet shape standing slightly apart from the others, shoulders loose, face half-lost in the hood. They do not scan the room the way a guard would — they attend to it the way someone attends to a door they cannot see. Their head tilts now and then, as if something just beyond hearing had shifted. They believe what matters has already passed through, and that the work is to hear what remains. They think the overly watchful are chasing reflections of reflections.", actions: ["talk", "inspect"] },
      covenant_initiate: { desc: "A newer face — robes still worn like borrowed weight, hands uncertain whether to clasp or hang open. When the adept or the adherent speaks, their gaze darts between them, weighing which cadence sounds like truth. They have not settled a position. They watch the player with the same unfinished attention: measuring whether you are another voice in the argument or something outside it.", actions: ["talk", "inspect"] },
